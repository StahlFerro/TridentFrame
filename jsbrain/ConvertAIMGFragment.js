...
let CON_in_duration = document.getElementById('CON_in_duration');
let CON_in_fps = document.getElementById('CON_in_fps');
...
function conLoadAIMG(res) {
    ...
    CON_in_duration.innerHTML = `${res.avg_duration} seconds`;
    CON_in_fps.innerHTML = `${res.fps} fps`;
...
function conClearAIMG() {
    ...
    CON_in_duration.innerHTML = '-';
    CON_in_fps.innerHTML = '-';
    CON_in_stage.src = '';
    CON_in_path.value = '';
    session.clearCache(() => {});
