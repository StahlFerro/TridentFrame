...
from pycore.imaging.png import create_animated_png
...
def create_aimg(image_paths: List[Path], out_path: Path, crbundle: CriteriaBundle) -> Path:
    ...
    if img_format == ImageFormat.GIF:
        ...
        return create_animated_gif(img_paths, out_path, crbundle)
        ...
        return create_animated_png(img_paths, out_path, crbundle)
