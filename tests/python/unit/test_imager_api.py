...
def test_malformed_combine_cmd_builder(fx_samples_spaced_dir_apng_checker: Path,
    ...
    malicious_path = Path(str(fx_samples_spaced_dir_apng_checker) + "; echo 'rm -rf';").resolve()
